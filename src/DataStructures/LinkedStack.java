...
public class LinkedStack<T> implements StackADT<T> {
    ...
    public void push(T element) {
        ...
        // The push method will insert a node with holds the given input into the top of
        // the stack
    ...
    public T peek() throws EmptyCollectionException {
        ...
        // This should look like pop, except we aren�t changing the stack at all. Just
